...
namespace AD.OpenXml.Structures
{
    ...
    public class Document
    {
        ...
        /// <summary>
        /// Cosntructs a <see cref="Relationships"/> instance from <see cref="Charts"/>, <see cref="Images"/>, and <see cref="Hyperlinks"/>.
        /// </summary>
        [NotNull]
        ...
        /// </summary>
        [NotNull]
        public IDictionary<string, XElement> ChartReferences => Charts.ToDictionary(x => x.RelationId.Value, x => x.Chart);
