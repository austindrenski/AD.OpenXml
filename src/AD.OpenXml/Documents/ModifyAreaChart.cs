...
namespace AD.OpenXml.Documents
{
    ...
    public static class ModifyAreaChartStylesExtensions
    {
        ...
        [NotNull]
        [ItemNotNull]
        public static async Task<MemoryStream> ModifyAreaChartStyles([NotNull] [ItemNotNull] this Task<MemoryStream> stream)
        {
            if (stream is null)
                throw new ArgumentNullException(nameof(stream));

            return await ModifyAreaChartStyles(await stream);
        }
        ...
        [NotNull]
        [ItemNotNull]
        public static async Task<MemoryStream> ModifyAreaChartStyles([NotNull] this MemoryStream stream)
        {
            if (stream is null)
                throw new ArgumentNullException(nameof(stream));
