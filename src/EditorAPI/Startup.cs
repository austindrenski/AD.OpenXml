...
namespace EditorAPI
{
    ...
    public class Startup : IStartup
    {
        ...
        public IServiceProvider ConfigureServices([NotNull] IServiceCollection services)
        {
            ...
            return services.AddLogging(x => x.AddConsole())
                           .AddApiVersioning(
                               x =>
                               {
                           ...
                           .AddSwaggerGen(
                               x =>
                               {
                                   ...
                                   x.IncludeXmlComments(Path.Combine(ApplicationEnvironment.ApplicationBasePath, $"{nameof(EditorAPI)}.xml"));
                                   x.IgnoreObsoleteActions();
                                   x.IgnoreObsoleteProperties();
                                   x.SwaggerDoc("v1", new Info { Title = "Editor API", Version = "v1" });
        ...
        public void Configure([NotNull] IApplicationBuilder app)
            => app.Use(
                  ...
                  .UseSwaggerUI(
                      ...
                      {
                          x.RoutePrefix = "docs";
                          x.DocumentTitle = "Editor API Documentation";
                          x.HeadContent = "Editor API Documentation";
                          x.SwaggerEndpoint("v1/swagger.json", "Editor API Documentation");
